...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<div class="row">
			<div class="span2">
			<img src="{{asset('themes/images/products/b1.jpg')}}" alt=""/>
			</div>
			<div class="span4">
				<h3>New | Available</h3>
				<hr class="soft"/>
	...
	<div class="row">
			<div class="span2">
				<img src="{{asset('themes/images/products/b2.jpg')}}" alt=""/>
			</div>
			<div class="span4">
				<h3>New | Available</h3>
				<hr class="soft"/>
	...
	<div class="row">
			<div class="span2">
				<img src="{{asset('themes/images/products/b3.jpg')}}" alt=""/>
			</div>
			<div class="span4">
				<h3>New | Available</h3>
				<hr class="soft"/>
	...
	<div class="row">
			<div class="span2">
				<img src="{{asset('themes/images/products/b4.jpg')}}" alt=""/>
			</div>
			<div class="span4">
				<h3>New | Available</h3>
				<hr class="soft"/>
